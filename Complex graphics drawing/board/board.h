...
/* TE pin. */
#define BOARD_MIPI_TE_PORT 0
#define BOARD_MIPI_TE_PIN  19
...
#define GPIO_DEBUG
#ifdef GPIO_DEBUG
#define GPIO_DEBUG_PORT_0 0
#define GPIO_DEBUG_PIN_0  5
#define GPIO_DEBUG_PORT_1 0
#define GPIO_DEBUG_PIN_1  6
#endif
#elif (BOARD_CUSTOMER_HB1 == 1)
/*! @brief The board name */
#define BOARD_NAME      "CUSTOMER_HB1"
...
status_t BOARD_InitPsRam(clock_attach_id_t clock_attach_id);
