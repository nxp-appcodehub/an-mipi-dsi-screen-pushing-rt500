...
#define VGLITE_HEAP_SZ 1048576/* 1.0 MB */
...
#else
extern volatile int32_t deepsleep_allowed[2];
#endif
...
//    vg_lite_scale(fb_width / 640.0f, fb_height / 480.0f, &matrix);
    ...
    vg_lite_scale(4, 4, &matrix);
    vg_lite_scale(fb_width / 480.0f, fb_height / 480.0f, &matrix);
